...
- Improved Balance corrections: now when you create/update/delete a transaction before "Balance correction" one, it'll be auto recalculated.
- Improved onboarding flow
- Migrated to LemonSqueezy for subscription billing instead of Stripe.
- Internal changes to improve the app's performance and stability.
